...
public class DashBoardFormController {
    ...
    public void LoginHomePageOnACtion(ActionEvent actionEvent) throws IOException {
        if (txtUserName.getText().equalsIgnoreCase("Admin") && txtPassword.getText().equalsIgnoreCase("A1999")) {
            ...
            stage1.close();
        } else if (txtUserName.getText().equalsIgnoreCase("Assistant") && txtPassword.getText().equalsIgnoreCase("A1111")) {
